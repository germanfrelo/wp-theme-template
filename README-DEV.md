...
4. **Find and replace placeholders.** Use your code editor's global search and replace feature to replace all instances of the following placeholders with your project's information:
   - `themeauthor`
   - `themedescription`
   - `themename`
   - `themerepourl`
