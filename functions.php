...
define( 'THEMESLUG_ASSETS_URL', THEMESLUG_THEME_URL . '/' . THEMESLUG_ASSETS_DIR_NAME );
define( 'THEMESLUG_DIST_URL', THEMESLUG_THEME_URL . '/' . THEMESLUG_DIST_DIR_NAME );

// --- Full Server Paths (for including files) ---
define( 'THEMESLUG_DIST_PATH', THEMESLUG_THEME_PATH . '/' . THEMESLUG_DIST_DIR_NAME );
...
define( 'THEMESLUG_EDITOR_STYLESHEET_URL', THEMESLUG_DIST_URL . '/css/editor.css' );
// Theme stylesheet: The Server Path for cache-busting (filemtime)
define( 'THEMESLUG_THEME_STYLESHEET_PATH', THEMESLUG_DIST_PATH . '/css/theme.css' );
