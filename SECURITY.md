...
| **Fix PR** | [#199](https://github.com/germanfrelo/wp-theme-template/pull/199) |
...
and k is the number of GLOBSTAR segments. With k=11 and n=30, a single call stalls the Node.js event
